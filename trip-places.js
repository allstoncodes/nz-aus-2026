...
const TRIP_PLACES = [
  ...
  { name: "Tucker Bar & Eatery", leg: "New Zealand", category: "food", city: "Tirau", booked: false, coords: [-37.9779, 175.7593], note: "Jul 11 lunch pick en route to Hobbiton" },
  { name: "Osteria Matamata", leg: "New Zealand", category: "food", city: "Matamata", booked: false, coords: [-37.8093, 175.7746], note: "Jul 11 lunch option near Hobbiton" },
  ...
  { name: "Rotorua Lakefront Village Green", leg: "New Zealand", category: "culture", city: "Rotorua", booked: false, coords: [-38.1338, 176.2516], note: "Jul 11 · Matariki night market + Aronui drone show" },
  ...
  { name: "Kuirau Park", leg: "New Zealand", category: "culture", city: "Rotorua", booked: false, coords: [-38.1350, 176.2400], note: "Free geothermal park" },
  { name: "Terrace Kitchen", leg: "New Zealand", category: "food", city: "Rotorua", booked: false, coords: [-38.1395, 176.2465], note: "Aronui Matariki Mixtape venue · Jul 11" },
  { name: "Wai Ariki Hot Springs & Spa", leg: "New Zealand", category: "wellness", city: "Rotorua", booked: false, coords: [-38.1400, 176.2560], note: "Matariki Soak/Sip/Show · Jul 9–11" },
  { name: "Mac's Steakhouse", leg: "New Zealand", category: "food", city: "Rotorua", booked: false, coords: [-38.1378, 176.2478], note: "Eat Streat · steaks" },
  { name: "SOBAR Surf and Turf", leg: "New Zealand", category: "food", city: "Rotorua", booked: false, coords: [-38.1378, 176.2478], note: "Eat Streat · surf & turf" },
